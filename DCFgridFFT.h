...
class DCFgridFFT{
	public:
		...
		void backward( NDarray::Array<float,3>&image,NDarray::Array< float,3 >&data, const NDarray::Array< float,3 >&kx, const NDarray::Array< float,3 >&ky, const NDarray::Array< float,3 >&kz);
