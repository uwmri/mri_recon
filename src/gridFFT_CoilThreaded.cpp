...
void gridFFT_CoilThreaded::precalc_gridding(int NzT,int NyT,int NxT, MRI_DATA &data){
 ...
 * @param kw k-space weight
 */
void gridFFT_CoilThreaded::backward_residual(const Array<complex<float>,3>&X,\
					   const Complex4D&smap,\
					   Complex4D&data,\
					   const Array<float,3>&kx,\
					   const Array<float,3>&ky,\
...
void gridFFT_CoilThreaded::accumulate( Array< complex<float>, 3>&X, const Complex4D&smap){
...
void gridFFT_CoilThreaded::chop_grid_forward( const Complex4D&dataA, const Array<float,3>&kxA,const Array<float,3>&kyA,const Array<float,3>&kzA,const Array<float,3>&kwA){
...
void gridFFT_CoilThreaded::chop_grid_backward(Complex4D&dataA, const Array<float,3>&kxA,const Array<float,3>&kyA,const Array<float,3>&kzA,const Array<float,3>&kwA, const Complex4D&diff_dataA,bool sub_data_flag){
