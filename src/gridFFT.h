...
class gridFFT {
 public:
  ...
  void chop_grid_forward(const NDarray::Array<complex<float>, 3> &data,
                         const NDarray::Array<float, 3> &kx,
                         const NDarray::Array<float, 3> &ky,
                         const NDarray::Array<float, 3> &kz,
                         const NDarray::Array<float, 3> &kw);
  void chop_grid_backward(NDarray::Array<complex<float>, 3> &data,
                          const NDarray::Array<float, 3> &kx,
                          const NDarray::Array<float, 3> &ky,
                          const NDarray::Array<float, 3> &kz,
                          const NDarray::Array<float, 3> &kw,
                          const NDarray::Array<complex<float>, 3> &diff_data,
                          bool);
