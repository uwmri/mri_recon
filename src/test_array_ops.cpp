...
int main(void) {
  ...
  T.tic();
  {
    ...
    Array<Array<complex<float>, 3>, 2> TEMP =
        Alloc5DContainer<complex<float> >(3, 4, 5, 6, 7);
  ...
  {
    cout << "Check BART Export" << endl;
    Array<Array<complex<float>, 3>, 2> TEMP1 =
        Alloc5DContainer<complex<float> >(3, 4, 1, 1, 1);
    Array<Array<complex<float>, 3>, 2> TEMP2 =
        Alloc5DContainer<complex<float> >(3, 4, 1, 1, 1);
    Array<Array<complex<float>, 3>, 2> TEMP3 =
        Alloc5DContainer<complex<float> >(3, 4, 1, 1, 1);
  ...
  for (Array<complex<float>, 3>::iterator miter = X.begin(); miter != X.end();
       miter++) {
    float val = abs(*miter);
