...
class TRANSFORMS {
 public:
  ...
  static void get_difference_transform(arma::cx_mat& A, arma::cx_mat& Ai,
                                       int N);
  ...
  static void ifft_e(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);
  ...
  static void inv_ediff(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);

  static void ewave(NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);
  static void inv_ewave(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);

  static void tdiff(NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);
  static void inv_tdiff(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);

  static void twave(NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);
  static void inv_twave(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp);

  static void multiply_in_time(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp, arma::cx_mat);
  static void multiply_in_encode(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2>& temp, arma::cx_mat);
