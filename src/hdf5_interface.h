...
void H5ArrayRead(H5::H5File &file, std::string GroupName, std::string Name, blitz::Array<T,N>& A){
	...
	if( rank != N ){
		std::cout << "Expected Rank " << N << " but opened a rank " << rank << " file " << std::endl << std::flush;
	}
	...
	if( total != A.numElements()){
		std::cout << "Dataspace has " << total << " points while array has " << A.numElements() << std::endl;
...
template< int N>
void H5ArrayWrite(H5::H5File &file, std::string GroupName, std::string Name, blitz::Array< complex<double>,N>& A){
...
template< int N>
void H5ArrayWrite(H5::H5File &file, std::string GroupName, std::string Name, blitz::Array< complex<float>,N>& A){
...
template< int N>
void H5ArrayWrite(H5::H5File &file, std::string GroupName, std::string Name, blitz::Array< double,N>& A){
...
template< int N>
void H5ArrayWrite(H5::H5File &file, std::string GroupName, std::string Name, NDarray::Array< float,N>& A){
