...
class THRESHOLD {
 public:
  ...
  void update_threshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef,
      WAVELET3D &wave, float);
  ...
  void setTemporalThresholding(
      bool flag);  // to skip the first frame in processing
  bool getTemporalThresholding();

 private:
  // Execute thresholding method
  void exec_multibandthreshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef,
      WAVELET3D &wave);
  ...
  // Get Threshold
  float get_threshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef, float);
  ...
  void get_visuthreshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef,
      WAVELET3D &wave);
  void get_bayesthreshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef,
      WAVELET3D &wave);
  void get_surethreshold(
      NDarray::Array<NDarray::Array<complex<float>, 3>, 2> &Coef,
      WAVELET3D &wave);
