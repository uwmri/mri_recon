...
class smsEncode{
	public:
		...
		NDarray::Array< NDarray::Array<complex<float>,3>,2> k3d_grid; /*Actual Gridding Space*/
		...
		void accumulate( NDarray::Array< NDarray::Array<complex<float>,3>,2>&X, NDarray::Array< complex<float>,3>&smap);
		
		//For setting images
		void set_image( NDarray::Array< NDarray::Array<complex<float>,3>,2>&X, NDarray::Array< complex<float>,3>&smap);
						
		void chop_grid_forward( NDarray::Array< NDarray::Array<complex<float>,3>,2>&data,\
					  NDarray::Array< NDarray::Array<float,3>,2>&kx,\
					  NDarray::Array< NDarray::Array<float,3>,2>&ky,\
					  NDarray::Array< NDarray::Array<float,3>,2>&kz,\
					  NDarray::Array< NDarray::Array<float,3>,2>&kw,\
